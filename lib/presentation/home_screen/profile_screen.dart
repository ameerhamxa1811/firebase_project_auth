...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    super.initState();
    // Load user details after the first frame
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<HomeScreenProvider>(context, listen: false).loadUserDetails();
    });
  }

  @override
  Widget build(BuildContext context) {
    final userProvider = Provider.of<HomeScreenProvider>(context);
    ...
    return Scaffold(
      ...
      body: user == null || userProvider.isLoading
        ...
        child: Column(
          children: [
            ...
            ElevatedButton.icon(
              onPressed: userProvider.isLoggingOut
                  ? null
                  : () => userProvider.logout(context),
              icon: userProvider.isLoggingOut
                  ? const CircularProgressIndicator(color: Colors.white)
                  : const Icon(Icons.logout),
              label: Text(userProvider.isLoggingOut ? 'Logging out...' : 'Logout'),
            ),
          ],
        ),
      ),
  ...
  void _showEditProfileDialog(BuildContext context) {
    final userProvider = Provider.of<HomeScreenProvider>(context, listen: false);
    final TextEditingController nameController = TextEditingController(text: userProvider.user?.name ?? '');
